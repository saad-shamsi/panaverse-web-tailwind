  ...
  return (
    ...
    <section className=' lg:mt-28 '>
      ...
      <div className='max-w-screeen-md'>
        ...
        <div className= " relative -top-20 w-44 h-36  bg-[#05c19b78] blur-3xl rounded-full z-0">
        </div>
        <h4 className=' -mt-24 text-slate-600 lg:text-xl sm:text-lg '>Every participant of the program will start by completing the following three core courses:</h4>
        <div className='mt-3'>
