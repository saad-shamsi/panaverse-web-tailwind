...
import ProgramOutcomeImg from "@/components/assests/images/program-outcome.png";
    ...
    <section className="mt-16 md:mt-28">
      <Wrapper>
        <div className="flex  flex-col-reverse md:flex-row items-center gap-x-8 ">
          {/* Left - image */}
          <div className="flex-1 mt-8 lg:mt-none">
            <Image src={ProgramOutcomeImg} alt="Program Outcome" />
          </div>
          {/* Right - content */}
          <div className="flex-1">
            ...
            <p className="text-lg text-slate-700 my-8 ">
            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-x-4 gap-y-8">
              {programOutcome.map((item, id) => (
