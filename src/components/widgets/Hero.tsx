  ...
  return (
    ...
    <Wrapper>
     <div className="flex flex-col md:flex-row  rounded-xl items-center">
      {/* left side  */}
      <div className="flex-1 max-w-screeen-sm ">
        ...
        <p className="mt-6 lg:text-xl sm:text-lg text-slate-600 ">
          A One and Quarter Years Panaverse DAO Earn as you Learn Program Getting Ready for the Next Generation of the Internet
        <p className="mt-6 lg:text-xl sm:text-lg text-slate-600 ">Consolidating Web 3.0, Metaverse, Artificial Intelligence (AI), Cloud, Edge, Ambient Computing/IoT, Network Automation, and Bioinformatics Technologies</p>
        </p>
        <div className="mt-6"
        >  <Button 
        text="Enroll Now"
